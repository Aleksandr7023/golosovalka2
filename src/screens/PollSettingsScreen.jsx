// src/screens/PollSettingsScreen.jsx — v3.015 — по профессиональному стандарту
...
export default function PollSettingsScreen() {
  ...
  // 5. Вспомогательная функция — сохранение
  const saveSettings = () => {
    if (!draftId) {
...
// FORCE_PUSH_TIMESTAMP: 2025-12-06 16:40:26